...
{
    Neuron neuron(Type::Implicit, true, 1, 1, 3, 25);
...
{
    Neuron neuron1(Type::Implicit, true, 1, 1, 3, 7, 5);
    Neuron neuron2(Type::Implicit, true, 1, 1, 0.1, 15, 0.5); 
    Neuron neuron3(Type::Implicit, true, 1, 1, 1, 50, 18); 
